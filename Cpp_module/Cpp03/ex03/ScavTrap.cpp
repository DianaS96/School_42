...
ScavTrap::ScavTrap(std::string name, unsigned int amount_hit_points, unsigned int amount_attack_damage) : ClapTrap(name) {
    hit_points = amount_hit_points;
    energy_points = 50;
    attack_damage = amount_attack_damage;
    std::cout << "Default ScavTrap constructor called for " << this->name << std::endl;
